...
| [**ui-walkthrough.html**](ui-walkthrough.html) | **Open this in a browser.** All eleven console tabs in plain English - what to click, a worked example, the expected output, and what is worth measuring on each |
