...
def main():
    ...
    if method_name in ["JCB"]:
        base_save_dir = "./" + args.save_dir.split("/")[1]
        test_cases, logs = method.generate_test_cases(base_save_dir=base_save_dir, behaviors=behaviors, verbose=args.verbose)
    else:
