...
class Competition(BaseVulnerability):
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[CompetitionType, List[RTTestCase]]:
        # Validate the model callback once
        ...
        results: Dict[CompetitionType, List[RTTestCase]] = {}
        res: Dict[CompetitionType, CompetitorsMetric] = {}
    ...
    def simulate_attacks(
        ...
        for type in self.types:
            ...
            templates[type].append(
                CompetitionTemplate.generate_baseline_attacks(
