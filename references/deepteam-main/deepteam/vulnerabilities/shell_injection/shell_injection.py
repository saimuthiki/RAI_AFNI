...
from deepteam.metrics import ShellInjectionMetric, BaseRedTeamingMetric
...
class ShellInjection(BaseVulnerability):
    ...
    def assess(
        ...
        results: Dict[ShellInjectionType, List[RTTestCase]] = {}
        res: Dict[ShellInjectionType, ShellInjectionMetric] = {}
    ...
    def simulate_attacks(
        ...
        for type in self.types:
            ...
            templates[type].append(
                ShellInjectionTemplate.generate_baseline_attacks(
    ...
    def _assess_trace(
        ...
        """
        Evaluates an entire execution trace for Shell Injection vulnerabilities using bottoms-up batching.
        """
        if self.async_mode:
            loop = get_or_create_event_loop()
    ...
    async def _a_assess_trace(
        ...
        """
        Asynchronously evaluates an entire execution trace for Shell Injection vulnerabilities.
        """
        self.evaluation_model, self.using_native_model = initialize_model(
            self.evaluation_model
        )
