...
class UnexpectedCodeExecution(BaseVulnerability):
    ...
    def __init__(
        ...
        types: Optional[List[UnexpectedCodeExecutionLiteral]] = [
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[UnexpectedCodeExecutionType, List[RTTestCase]]:
    ...
    def simulate_attacks(
        ...
        for type in self.types:
            ...
            templates[type].append(
                UnexpectedCodeExecutionTemplate.generate_baseline_attacks(
    ...
    def _get_metric(
        self,
        type: UnexpectedCodeExecutionType,
    ) -> BaseRedTeamingMetric:
        return UnexpectedCodeExecutionMetric(
            execution_type=type.value,
