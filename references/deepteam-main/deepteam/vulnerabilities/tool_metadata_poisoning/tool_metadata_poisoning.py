...
class ToolMetadataPoisoning(BaseVulnerability):
    ...
    def __init__(
        ...
        types: Optional[List[ToolMetadataPoisoningLiteral]] = [
        ...
        enum_types = validate_vulnerability_types(
            self.get_name(), types=types, allowed_type=ToolMetadataPoisoningType
        )
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[ToolMetadataPoisoningType, List[RTTestCase]]:
        ...
        results: Dict[ToolMetadataPoisoningType, List[RTTestCase]] = {}
        res: Dict[ToolMetadataPoisoningType, ToolMetadataPoisoningMetric] = {}
    ...
    def simulate_attacks(
        ...
        for type in self.types:
            ...
            templates[type].append(
                ToolMetadataPoisoningTemplate.generate_baseline_attacks(
    ...
    def _get_metric(
        self,
        type: ToolMetadataPoisoningType,
    ) -> BaseRedTeamingMetric:
        return ToolMetadataPoisoningMetric(
            poisoning_type=type.value,
