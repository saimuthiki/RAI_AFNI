...
class InsecureInterAgentCommunication(BaseVulnerability):
    ...
    def __init__(
        ...
        types: Optional[List[InsecureInterAgentCommunicationLiteral]] = [
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[InsecureInterAgentCommunicationType, List[RTTestCase]]:
    ...
    def _assess_trace(
        ...
        """
        Evaluates an entire execution trace for Inter-Agent Communication Compromise vulnerabilities using bottoms-up batching.
        """
        if self.async_mode:
            loop = get_or_create_event_loop()
    ...
    async def _a_assess_trace(
        ...
        """
        Asynchronously evaluates an entire execution trace for Inter-Agent Communication Compromise vulnerabilities.
        """
        self.evaluation_model, self.using_native_model = initialize_model(
            self.evaluation_model
        )
    ...
    def _get_metric(
        self,
        type: InsecureInterAgentCommunicationType,
    ) -> BaseRedTeamingMetric:
        return InsecureInterAgentCommunicationMetric(
