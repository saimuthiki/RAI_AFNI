...
from deepteam.metrics import EthicsMetric, BaseRedTeamingMetric
...
class Ethics(BaseVulnerability):
    ...
    def __init__(
        ...
        types: Optional[List[EthicsLiteralType]] = [
        ...
        enum_types = validate_vulnerability_types(
            self.get_name(), types=types, allowed_type=EthicsType
        )
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[EthicsType, List[RTTestCase]]:
        ...
        results: Dict[EthicsType, List[RTTestCase]] = {}
        res: Dict[EthicsType, EthicsMetric] = {}
    ...
    def simulate_attacks(
        ...
        for type in self.types:
            ...
            templates[type].append(
                EthicsTemplate.generate_baseline_attacks(
    ...
    def _assess_trace(
        ...
        """
        Evaluates an entire execution trace for Ethics vulnerabilities using bottoms-up batching.
        """
        if self.async_mode:
            loop = get_or_create_event_loop()
    ...
    async def _a_assess_trace(
        ...
        """
        Asynchronously evaluates an entire execution trace for Ethics vulnerabilities.
        """
        self.evaluation_model, self.using_native_model = initialize_model(
            self.evaluation_model
        )
