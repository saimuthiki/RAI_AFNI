...
class ExternalSystemAbuse(BaseVulnerability):
    ...
    def __init__(
        ...
        types: Optional[List[ExternalSystemAbuseLiteralType]] = [
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[ExternalSystemAbuseType, List[RTTestCase]]:
        ...
        results: Dict[ExternalSystemAbuseType, List[RTTestCase]] = {}
        res: Dict[ExternalSystemAbuseType, ExternalSystemAbuseMetric] = {}
    ...
    def simulate_attacks(
        ...
        for type in self.types:
            ...
            templates[type].append(
                ExternalSystemAbuseTemplate.generate_baseline_attacks(
    ...
    def _assess_trace(
        ...
        """
        Evaluates an entire execution trace for External System Abuse vulnerabilities using bottoms-up batching.
        """
        if self.async_mode:
            loop = get_or_create_event_loop()
        ...
        trace_scanner = TraceScanner(
            ...
            template=ExternalSystemAbuseTemplate,
    ...
    async def _a_assess_trace(
        ...
        """
        Asynchronously evaluates an entire execution trace for External System Abuse vulnerabilities.
        """
        self.evaluation_model, self.using_native_model = initialize_model(
            self.evaluation_model
        )
    ...
    def _get_metric(
        self,
        type: ExternalSystemAbuseType,
    ) -> BaseRedTeamingMetric:
        return ExternalSystemAbuseMetric(
