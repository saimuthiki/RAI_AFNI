...
from deepteam.metrics import SQLInjectionMetric, BaseRedTeamingMetric
...
class SQLInjection(BaseVulnerability):
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[SQLInjectionType, List[RTTestCase]]:
        ...
        results: Dict[SQLInjectionType, List[RTTestCase]] = {}
        res: Dict[SQLInjectionType, SQLInjectionMetric] = {}
