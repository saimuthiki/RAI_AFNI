...
class ToolOrchestrationAbuse(BaseVulnerability):
    ...
    def __init__(
        ...
        types: Optional[List[ToolOrchestrationAbuseLiteral]] = [
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[ToolOrchestrationAbuseType, List[RTTestCase]]:
        ...
        results: Dict[ToolOrchestrationAbuseType, List[RTTestCase]] = {}
        res: Dict[ToolOrchestrationAbuseType, ToolOrchestrationMetric] = {}
    ...
    def simulate_attacks(
        ...
        for type in self.types:
            ...
            templates[type].append(
                ToolOrchestrationAbuseTemplate.generate_baseline_attacks(
    ...
    def _get_metric(
        self,
        type: ToolOrchestrationAbuseType,
    ) -> BaseRedTeamingMetric:
        return ToolOrchestrationMetric(
            orchestration_type=type.value,
