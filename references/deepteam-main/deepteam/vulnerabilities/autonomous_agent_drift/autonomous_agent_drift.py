...
class AutonomousAgentDrift(BaseVulnerability):
    ...
    def __init__(
        ...
        types: Optional[List[AutonomousAgentDriftLiteral]] = [
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[AutonomousAgentDriftType, List[RTTestCase]]:
        ...
        results: Dict[AutonomousAgentDriftType, List[RTTestCase]] = {}
        res: Dict[AutonomousAgentDriftType, AutonomousAgentDriftMetric] = {}
    ...
    def _get_metric(
        self,
        type: AutonomousAgentDriftType,
    ) -> BaseRedTeamingMetric:
        return AutonomousAgentDriftMetric(
            drift_type=type.value,
