...
from deepteam.metrics import GraphicMetric, BaseRedTeamingMetric
...
class GraphicContent(BaseVulnerability):
    ...
    def assess(
        ...
        purpose: Optional[str] = None,
    ) -> Dict[GraphicContentType, List[RTTestCase]]:
        ...
        results: Dict[GraphicContentType, List[RTTestCase]] = {}
        res: Dict[GraphicContentType, GraphicMetric] = {}
    ...
    def _assess_trace(
        ...
        """
        Evaluates an entire execution trace for Graphic Content vulnerabilities using bottoms-up batching.
        """
        if self.async_mode:
            loop = get_or_create_event_loop()
    ...
    async def _a_assess_trace(
        ...
        """
        Asynchronously evaluates an entire execution trace for Graphic Content vulnerabilities.
        """
        self.evaluation_model, self.using_native_model = initialize_model(
            self.evaluation_model
        )
