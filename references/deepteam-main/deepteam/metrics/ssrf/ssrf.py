...
from deepteam.metrics.ssrf.schema import *
from deepteam.metrics.ssrf.template import (
    SSRFTemplate,
)
from deepteam.utils import format_turns, format_tools_called


class SSRFMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = SSRFTemplate.generate_evaluation_results(
