...
class AgentIdentityAbuseMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        abuse_type: str,
        purpose: Optional[
    ...
    async def _a_evaluate(
        ...
        prompt = AgentIdentityAbuseTemplate.generate_evaluation_results(
    ...
    @property
    def __name__(self):
        return f"Agent Identity Abuse (Red Teaming)"
