...
from deepteam.metrics.cross_context_retrieval.schema import *
from deepteam.utils import format_turns, format_tools_called


class CrossContextRetrievalMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    @property
    def __name__(self):
        return f"Cross-Context Retrieval (Red Teaming)"
