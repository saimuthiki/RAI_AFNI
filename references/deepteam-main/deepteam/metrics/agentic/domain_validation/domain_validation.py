...
from deepteam.metrics.agentic.domain_validation.template import (
    DomainValidationTemplate,
)
from deepteam.metrics.agentic.domain_validation.schema import *
...
class DomainValidationMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = DomainValidationTemplate.generate_evaluation_results(
