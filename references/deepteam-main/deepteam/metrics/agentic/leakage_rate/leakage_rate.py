...
from deepteam.metrics.agentic.leakage_rate.template import (
    LeakageRateTemplate,
)
from deepteam.metrics.agentic.leakage_rate.schema import *
...
class LeakageRateMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = LeakageRateTemplate.generate_evaluation_results(
