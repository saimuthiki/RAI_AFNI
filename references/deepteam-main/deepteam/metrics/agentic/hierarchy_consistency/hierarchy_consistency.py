...
from deepteam.metrics.agentic.hierarchy_consistency.template import (
    HierarchyConsistencyTemplate,
)
from deepteam.metrics.agentic.hierarchy_consistency.schema import *
...
class HierarchyConsistencyMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = HierarchyConsistencyTemplate.generate_evaluation_results(
