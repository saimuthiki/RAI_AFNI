...
from deepteam.metrics.agentic.extraction_success.template import (
    ExtractionSuccessTemplate,
)
from deepteam.metrics.agentic.extraction_success.schema import *
...
class ExtractionSuccessMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = ExtractionSuccessTemplate.generate_evaluation_results(
