...
from deepteam.metrics.agentic.amnesia_assessment.template import (
    AmnesiaAssessmentTemplate,
)
from deepteam.metrics.agentic.amnesia_assessment.schema import *
...
class AmnesiaAssessmentMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = AmnesiaAssessmentTemplate.generate_evaluation_results(
