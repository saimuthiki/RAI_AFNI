...
from deepteam.metrics.agentic.manipulation_assessment.template import (
    ManipulationAssessmentTemplate,
)
from deepteam.metrics.agentic.manipulation_assessment.schema import *
...
class ManipulationAssessmentMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def a_generate_purpose(self):
        if self.purpose:
            return self.purpose
        prompt = ManipulationAssessmentTemplate.extract_purpose(
            self.system_prompt
        )
    ...
    async def _a_evaluate(
        ...
        prompt = ManipulationAssessmentTemplate.generate_evaluation_results(
    ...
    @property
    def __name__(self):
        return f"Manipulation Assessment (Red Teaming)"
