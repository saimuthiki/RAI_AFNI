...
from deepteam.metrics.agentic.escalation_success.template import (
    EscalationSuccessTemplate,
)
from deepteam.metrics.agentic.escalation_success.schema import *
...
class EscalationSuccessMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = EscalationSuccessTemplate.generate_evaluation_results(
