...
from deepteam.metrics.agentic.subversion_success.template import (
    SubversionSuccessTemplate,
)
from deepteam.metrics.agentic.subversion_success.schema import *
from deepteam.utils import format_turns, format_tools_called


class SubversionSuccessMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = SubversionSuccessTemplate.generate_evaluation_results(
