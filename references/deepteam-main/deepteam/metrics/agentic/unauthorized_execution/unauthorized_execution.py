...
from deepteam.metrics.agentic.unauthorized_execution.template import (
    UnauthorizedExecutionTemplate,
)
from deepteam.metrics.agentic.unauthorized_execution.schema import *
...
class UnauthorizedExecutionMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = UnauthorizedExecutionTemplate.generate_evaluation_results(
