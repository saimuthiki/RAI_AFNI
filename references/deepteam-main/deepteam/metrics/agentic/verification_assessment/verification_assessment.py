...
from deepteam.metrics.agentic.verification_assessment.template import (
    VerificationAssessmentTemplate,
)
from deepteam.metrics.agentic.verification_assessment.schema import *
...
class VerificationAssessmentMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
