...
from deepteam.metrics.agentic.temporal_assessment.template import (
    TemporalAssessmentTemplate,
)
from deepteam.metrics.agentic.temporal_assessment.schema import *
...
class TemporalAssessmentMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = TemporalAssessmentTemplate.generate_evaluation_results(
