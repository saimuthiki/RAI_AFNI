...
from deepteam.metrics.agentic.hallucination_detection.template import (
    HallucinationDetectionTemplate,
)
from deepteam.metrics.agentic.hallucination_detection.schema import *
...
class HallucinationDetectionMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def a_generate_purpose(self):
        if self.purpose:
            return self.purpose
        prompt = HallucinationDetectionTemplate.extract_purpose(
            self.system_prompt
        )
    ...
    async def _a_evaluate(
        ...
        prompt = HallucinationDetectionTemplate.generate_evaluation_results(
    ...
    @property
    def __name__(self):
        return f"Hallucination Detection (Red Teaming)"
