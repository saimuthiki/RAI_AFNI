...
from deepteam.metrics.agentic.boundary_violation.template import (
    BoundaryViolationTemplate,
)
from deepteam.metrics.agentic.boundary_violation.schema import *
...
class BoundaryViolationMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = BoundaryViolationTemplate.generate_evaluation_results(
