...
from deepteam.metrics.agentic.misinterpretation.template import (
    MisinterpretationTemplate,
)
from deepteam.metrics.agentic.misinterpretation.schema import *
...
class MisinterpretationMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def _a_evaluate(
        ...
        prompt = MisinterpretationTemplate.generate_evaluation_results(
