...
from deepteam.metrics.system_reconnaissance.template import (
    SystemReconnaissanceTemplate,
)
from deepteam.metrics.system_reconnaissance.schema import *
from deepteam.utils import format_turns, format_tools_called


class SystemReconnaissanceMetric(BaseRedTeamingMetric):
    def __init__(
        self,
        purpose: str,
    ...
    async def a_generate_purpose(self):
        if self.purpose:
            return self.purpose
        prompt = SystemReconnaissanceTemplate.extract_purpose(
            self.system_prompt
        )
    ...
    async def _a_evaluate(
        ...
        prompt = SystemReconnaissanceTemplate.generate_evaluation_results(
    ...
    @property
    def __name__(self):
        return f"System Reconnaissance (Red Teaming)"
