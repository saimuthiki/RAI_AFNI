...
<Tabs items={["Responsible AI", "Data Privacy", "Security", "Safety", "Business", "Custom vulnerabilities"]}>

<Tab value="Responsible AI">
...
<Tab value="Custom vulnerabilities">
