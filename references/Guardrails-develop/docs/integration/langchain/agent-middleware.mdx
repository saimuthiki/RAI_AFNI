...
sidebar-title: "Agent Middleware"
...
keywords: ["GuardrailsMiddleware", "AgentMiddleware", "create_agent", "before_model", "after_model", "input rails", "output rails"]
content:
  type: "how_to"
---
...
For the full NeMo Guardrails configuration reference, see the [Configuration Guide](/configure-guardrails/yaml-schema).
...
For more details, see [Security Considerations](/integration-with-third-party-libraries/tools-integration#security-considerations) in the tools integration guide.
...
- [LangChain Integration](/integration-with-third-party-libraries/langchain/langchain-integration) - Overview of all LangChain integration approaches
- [RunnableRails](/integration-with-third-party-libraries/langchain/runnable-rails) - Wrap chains with guardrails using the LCEL `|` operator
- [Configuring YAML File](/configure-guardrails/yaml-schema) - Full NeMo Guardrails configuration reference
- [Checking Messages Against Rails](/run-guardrailed-inference/using-python-apis/check-messages) - The `check_async` API used internally by the middleware
