...
title: "Deploy the NeMo Guardrails Library with Docker"
sidebar-title: "Docker"
...
```bash
docker run -p 1337:1337 jailbreak_detection_heuristics
```
...
For a hands-on configuration walkthrough, see [Use Jailbreak Detection Heuristics](/get-started/tutorials/jailbreak-detection-heuristics).
