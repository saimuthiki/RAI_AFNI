...
title: "Cisco AI Defense Integration"
---
...
![High-level flow through programmable guardrails including AI Defense integration, showing how Cisco AI Defense provides privacy, safety, and security inspection for both input and output rails](../../../_static/images/guardrails_flow_ai_defense.png "High-level flow through programmable guardrails including AI Defense integration, showing how Cisco AI Defense provides privacy, safety, and security inspection for both input and output rails")
...
For more information on Cisco AI Defense capabilities and configuration, please refer to the [Cisco AI Defense documentation](https://developer.cisco.com/docs/ai-defense-inspection/).
