...
title: "Patronus Evaluate API Integration"
---
NeMo Guardrails supports using [Patronus AI](https://www.patronus.ai)'s Evaluate API as an output rail. The Evaluate API gives you access to Patronus' powerful suite of fully-managed in-house evaluation models, including [Lynx](/configure-guardrails/guardrail-catalog/third-party/patronus-lynx), Judge (a hosted LLM-as-a-Judge model), Toxicity, PII, and PHI models, and a suite of specialized RAG evaluators with
...
2. You can follow the Quick Start guide [here](https://docs.patronus.ai/docs/quickstart_eval) to get onboarded.
