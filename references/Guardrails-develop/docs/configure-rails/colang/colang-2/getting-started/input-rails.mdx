...
title: "Input Rails"
description: "This section explains how to create *input rails* in Colang 2.0."
---

<a id="colang_2_getting_started_input_rails"></a>
...
```
The [next example](interaction-loop#colang_2_getting_started_interaction_loop) will show you how to create a simple interaction loop.
