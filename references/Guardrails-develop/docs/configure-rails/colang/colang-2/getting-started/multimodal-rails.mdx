...
title: "Multimodal Rails"
description: "This section explains how to create multimodal rails in Colang 2.0."
---

<a id="colang_2_getting_started_multimodal_rails"></a>
...
flow bot express verbal greeting
  bot say "Hi there!"
    ...
    or bot say "Hello!"
```
In the flow above, lines 37 and 45 use the pre-defined flows `user gestured` and `bot gesture` which match user gestures and control bot gestures.
...
Gesture: Smile and wave with one hand.
```
The [next example](input-rails#colang_2_getting_started_input_rails) will show you how define input rails.
