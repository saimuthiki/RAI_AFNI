...
`nemoguardrails.testing`. Its main building blocks are:
...
- `RecordingHTTPClient`: a scriptable implementation of the outbound HTTP
  client protocol that records requests and returns queued responses.
